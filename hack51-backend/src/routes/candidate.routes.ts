...
// ── Submissions ───────────────────────────────────────────────────────────────
// Get a signed URL to upload an artifact file (for artifact_type "upload"/"both").
// The file is uploaded directly to Supabase Storage; submit with the returned public_url.
candidateRouter.post("/uploads/sign",          authMiddleware, isCandidate, UploadController.createSignedUpload);
